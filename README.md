...
Site fictíco desenvolvido para praticar HTML, CSS e Bootstrap.
...
-Aprimorar conhecimentos em Bootstrap;
...
Para visualizar o site no GitHubPages <a href="https://cleuber-andrade.github.io/clone_Spotify/" target="_blank">Clique aqui</a>

## 👷 Como rodar

```bash
# Clonar o repositório
git clone https://github.com/cleuber-andrade/clone_Spotify.git
